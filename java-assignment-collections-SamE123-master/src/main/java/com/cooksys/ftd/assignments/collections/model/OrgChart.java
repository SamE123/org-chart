...
public class OrgChart {
	...
	private Set<Employee> org = new HashSet<Employee>();
    ...
    public boolean addEmployee(Employee employee) {
    	...
    	if(employee == null || this.hasEmployee(employee))
    		return false;
    ...
    public Set<Employee> getAllEmployees() {
    	return new HashSet<Employee>(org);
    }
    ...
    public Set<Manager> getAllManagers() {
    	...
    	Set<Manager> manSet = new HashSet<Manager>();
    	
    	for(Employee e : org) {
    		if(e instanceof Manager)
    			manSet.add((Manager) e);
    	}
    ...
    public Set<Employee> getDirectSubordinates(Manager manager) {
    	...
    	if(!org.contains(manager))
    		return s;
    	
    	for(Employee e : org) {
    		if(e.hasManager() && e.getManager().equals(manager))
    			s.add(e);
    	}
    ...
    public Map<Manager, Set<Employee>> getFullHierarchy() {
    	...
    	Map<Manager, Set<Employee>> orgMap = new HashMap<Manager, Set<Employee>>();
    	
    	Set<Manager> manSet = this.getAllManagers();
    	
    	for(Manager m : manSet) {
    		orgMap.put(m, this.getDirectSubordinates(m));
    	}
